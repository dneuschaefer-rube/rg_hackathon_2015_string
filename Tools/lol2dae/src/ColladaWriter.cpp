...
void ColladaWriter::writeFile(const char* path, Mode& mode)
{
	filePath = path;
...
void ColladaWriter::writeMaterial()
{
	...
	outFile << "\t\t" << "<effect id=\"" << name << "Lambert\">" << endl;
	...
	outFile << "\t\t" << "<material id=\"" << name << "Material\">" << endl;
	outFile << "\t\t\t" << "<instance_effect url=\"#" << name << "Lambert\"/>" << endl;
...
void ColladaWriter::writeMesh()
{
	...
	outFile << "\t\t\t\t" << R"(<triangles count=")" << (int)indices.size() / 3 << "\" material=\"" << name << "Material\">" << endl;
...
void ColladaWriter::writeScene(Mode& mode)
{
	...
	if (mode == Mode::Mesh)
	{
		...
		outFile << "\t\t\t\t\t\t" << "<technique_common>" << endl;
		outFile << "\t\t\t\t\t\t\t" << "<instance_material symbol=\"" << name << "Material\" target=\"#" << name << "Material\"/>" << endl;
		outFile << "\t\t\t\t\t\t" << "</technique_common>" << endl;
		outFile << "\t\t\t\t\t" << "</bind_material>" << endl;
		...
		outFile << "\t" << "</library_visual_scenes>" << endl;
		outFile << "\t" << "<scene>" << endl;
		outFile << "\t\t" << "<instance_visual_scene url=\"#DefaultScene\"/>" << endl;
		outFile << "\t" << "</scene>" << endl;
